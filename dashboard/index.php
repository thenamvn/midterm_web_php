        ...
        <div class="header">
            ...
            <div class="header-button">
                <div class="header-left">
                    ...
                    <form class="importForm" action="index.php" method="post" enctype="multipart/form-data" style="display:inline;">
                        <div class="importContainer">
                            <input type="file" name="importFile" accept=".csv" required>
                            <button class="normalButton" type="submit" name="importCSV">Import CSV</button>
                        </div>
                    </form>
                </div>
